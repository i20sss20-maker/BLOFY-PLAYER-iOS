...
target.build_configurations.each do |c|
 c.build_settings.merge!({'PRODUCT_BUNDLE_IDENTIFIER'=>'tv.blofy.player.ios','PRODUCT_NAME'=>'BlofyPlayer','SWIFT_VERSION'=>'5.0','IPHONEOS_DEPLOYMENT_TARGET'=>'16.0','TARGETED_DEVICE_FAMILY'=>'1,2','INFOPLIST_FILE'=>'BlofyPlayer/Info.plist','GENERATE_INFOPLIST_FILE'=>'NO','CODE_SIGNING_ALLOWED'=>'NO','CODE_SIGNING_REQUIRED'=>'NO','CODE_SIGN_IDENTITY'=>'','DEVELOPMENT_TEAM'=>'','MARKETING_VERSION'=>'0.2.0','CURRENT_PROJECT_VERSION'=>ENV.fetch('BLOFY_IOS_BUILD_NUMBER','1'),'FRAMEWORK_SEARCH_PATHS'=>['$(inherited)','$(PROJECT_DIR)/Vendor']})
end
project.save
...
puts 'Generated BlofyPlayer.xcodeproj with VLCKit'
